#!/usr/bin/env bash
# Build an air-gap bundle: the container image, the Helm chart, and the
# offline evidence verifier, in a single tarball for transfer into a
...
3. ./omni-verify -bundle <evidence-dir> -pubkey <key> -head <hash>   # audit evidence
EOF
